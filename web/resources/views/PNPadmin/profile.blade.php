                                    ...
                                    <div class="col-lg-4 col-xl-3">
                                        <div class="profile-content-left pt-5 pb-3 px-4 px-xl-4">
                                            <div class="card text-center widget-profile px-0 border-0">
                                                ...
                                                @if(Auth::guard('admin')->user()->image == "TBD")
                                                    <img id="image-change" src="{{asset("uploads/user.jpg")}}" alt="user image" class="img-fluid">
                                                @else
                                                    <img id="image-change" src="{{asset(Auth::guard('admin')->user()->image)}}" alt="user image" class="img-fluid">
                                                @endif
                                                </div>
                                                <div class="card-body">
                                                    <h4 class="py-2 text-dark">{{Auth::guard('admin')->user()->admin_name}}</h4>
                                                </div>
                                            </div>
                                            <hr class="w-100">
                                            <div class="contact-info pt-4">
                                                ...
                                                <p>{{Auth::guard('admin')->user()->admin_contactno}}</p>
                                                <p class="text-dark font-weight-medium pt-4 mb-2">Address</p>
                                                <p>{{Auth::guard('admin')->user()->admin_location}}</p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <ul class="nav nav-tabs px-4" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="details-tab" data-toggle="tab" href="#details" role="tab"aria-selected="true">
                                                        <i class="mdi mdi-account mr-2"></i>Admin Details
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    ...
                                                    <div class="mt-5">
                                                        <div class="form-row">
                                                            <div class="col-md-12">
                                                                ...
                                                                @csrf
                                                                <input type="hidden" id="update-profile-id" value="{{ Auth::guard('admin')->user()->id }}">
                                                                ...
                                                                <div class="form mb-3">
                                                                    ...
                                                                    <input name="admin_name" id="update-profile-name" type="text" class="form-control" value="{{ Auth::guard('admin')->user()->admin_name }}" required oninvalid="$(this).addClass('is-invalid')" oninput="$(this).removeClass('is-invalid')">
                                                                    <div class="invalid-feedback">Please input this field</div>
                                                                </div>
                                                                <div class="form mb-3">
                                                                    <label class="text-dark font-size-16">Admin Contact #</label>
                                                                    <input name="admin_contactno" id="update-profile-contactno" type="text" class="form-control" data-mask="(999) 999-9999" value="{{ Auth::guard('admin')->user()->admin_contactno }}">
                                                                ...
                                                                <div class="form mb-3">
                                                                    ...
                                                                    <input name="admin_location" id="update-profile-location" type="text" class="form-control" value="{{ Auth::guard('admin')->user()->admin_location }}">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input name="location_lat" id="update-profile-lat" type="text" class="form-control" value="{{ Auth::guard('admin')->user()->location_lat}}">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="text-dark font-size-16">Lng</label>
                                                                    <input name="location_lng" id="update-profile-lng" type="text" class="form-control" value="{{ Auth::guard('admin')->user()->location_lng }}">
                                                                </div>
                                                                </div>
                                                    ...
                                                    <div class="mt-5">
                                                        <div class="form-row">
                                                            <div class="col-md-12">
                                                                ...
                                                                @csrf
                                                                <input type="hidden" id="profile-id-username" value="{{ Auth::guard('admin')->user()->id }}">
                                                                    ...
                                                                    <div class="form mb-3">
                                                                        ...
                                                                        <input name="username" id="profile-username" type="text" class="form-control" value="{{ Auth::guard('admin')->user()->username }}" required oninput="$(this).removeClass('is-invalid')">
                                                    ...
                                                    <div class="mt-5">
                                                        <div class="form-row">
                                                            <div class="col-md-12">
                                                                ...
                                                                @csrf
                                                                <input type="hidden" id="profile-id-password" value="{{ Auth::guard('admin')->user()->id }}">
...
<script>
    function initMap() {
        ...
        mapOptions = {
            zoom: 15,
            center: {
                lat: {{Auth::guard('admin')->user()->location_lat}},
                lng: {{Auth::guard('admin')->user()->location_lng}}
            },
...
$('#update-username-form').on('submit', function(event) {
  ...
  $.ajax({
    type: "POST",
    url: "/admin/profile/updateusername/"+username_id,
...
$('#update-profile-form').on('submit', function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "/admin/profile/updateprofile/"+profile_id,
...
$('#update-password-form').on('submit', function(event) {
  ...
  $.ajax({
    type: "POST",
    url: "/admin/profile/updatepassword/"+profile_id_pw,
