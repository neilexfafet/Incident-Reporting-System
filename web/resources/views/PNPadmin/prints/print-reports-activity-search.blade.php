...
<div class="row">
    <div class="col-12">
        <div class="card card-default">
            ...
            <div class="d-flex justify-content-end pb-2 px-4">
                <h3 class="pr-4">From: {{Carbon\Carbon::parse($from)->format('F j, Y')}}</h3>
                <h3>To: {{Carbon\Carbon::parse($to)->format('F j, Y')}}</h3>
            </div>
            <div class="row col-lg-12 d-flex justify-content-between pt-2 pb-4" id="ave">
