...
<head>
    <title>PNP | Statistical Reports</title>
...
<div class="wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
                ...
                <div class="breadcrumb-wrapper">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page">
                                <a id="scroll-to-stations-activity" href="javscript:void(0);">Stations Activity</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">
                                <a id="scroll-to-users-activity" href="javscript:void(0);">Users Activity</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page">
                                <a id="scroll-to-report-logs" href="javscript:void(0);">Incident Report Logs</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">
                            ...
                            <li class="breadcrumb-item" aria-current="page">
                                <a id="scroll-to-users-list" href="javscript:void(0);">Users List</a>
                            </li>
                        </ol>
                    </nav>
                </div>
            ...
            <!--CONTENT SECTION-->
                <div class="row" id="reports-activity">
                    <div class="col-12">
                        <div class="card card-default">
                            <ul class="nav nav-tabs ml-4 mt-4 nav-style-border pl-0 justify-content-between justify-content-xl-start" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#all" role="tab" aria-controls="all" aria-selected="true">All Reports</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#station" role="tab" aria-controls="station" aria-selected="false">Station Reports</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent3">
                                <div class="tab-pane pt-3 fade show active" id="all" role="tabpanel">
                                    @if($incidents != 0)
                                    <div class="row no-gutters">
                                            ...
                                            <form id="reports-activity-search">
                                                ...
                                                <div class="card-header justify-content-between py-4">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div id="reports-activity-date-range" class="date-range-report mr-2"><span>Select Date</span></div>
                                        ...
                                        <div class="col-xl-8">
                                            <div class="border-right">
                                                <div id="reports-activity-loader">@include('PNPadmin.includes.loader')</div>
                                                <div id="reports-activity-form-display" style="display: none;">
                                                    ...
                                                    <div class="p-4">
                                                        <a href="{{url('admin/print/reports-activity')}}" target="_blank" class="btn btn-sm btn-secondary"><i class="mdi mdi-printer"></i> Print or Save</a>
                                                    </div>
                                                </div>
                                                <div id="reports-activity-form-display-search" style="display: none;">
                                                    ...
                                                    <div class="p-4">
                                                        <form action="{{url('admin/print/reports-activity/search')}}" method="POST" target="_blank">
                                                        @csrf
                                                        <input name="from" type="hidden" id="reports-activity-print-from">
                                                        <input name="to" type="hidden" id="reports-activity-print-to">
                                        ...
                                        <div class="col-xl-4">
                                            <div data-scroll-height="642">
                                                <div class="card-header row pt-4 mx-0 px-0">
                                                    ...
                                                    <div class="row col-lg-12 d-flex justify-content-between">
                                                        <span class="text-center pl-4">Day <h4 id="reports-activity-ave-per-day"></h4></span>
                                                        <span class="text-center">Week <h4 id="reports-activity-ave-per-week"></h4></span>
                                                        <span class="text-center">Month <h4 id="reports-activity-ave-per-month"></h4></span>
                                                        <span class="text-center">Year <h4 id="reports-activity-ave-per-year"></h4></span>
                                                    </div>
                                                </div>
                                                <div class="border-bottom"></div>
                                                <div id="reports-activity-loader-barchart">@include('PNPadmin.includes.loader')</div>
                                                <div class="card-body">
                                ...
                                <div class="tab-pane pt-3 fade" id="station" role="tabpanel" >
                                    <div class="row no-gutters">
                                        <div class="col-lg-12">
                                            <form id="reports-activity-station-form">
                                            @csrf
                                                <div class="card-header justify-content-between py-4">
                                                    <h2>Incident Reports Activity</h2>
                                                    <div class="row d-flex justify-content-end">
                                                        <span class="font-size-17">Station: </span>
                                                        <select name="station_id" class="custom-select custom-select-sm mr-2" required oninvalid="$(this).addClass('is-invalid')" oninput="$(this).removeClass('is-invalid')">
                                                            <option selected disabled value="">Choose Station</option>
                                                            @foreach($stations as $station)
                                                                <option value="{{$station->id}}">{{$station->station_name}}</option>
                                                            @endforeach
                                                        </select>
                                                        <button type="submit" class="btn btn-outline-primary btn-sm"><i class="mdi mdi-format-columns"></i> View Activity</button>
                                                    </div>
                                                </div>
                                            </form>
                                        <div id="reports-activity-station-loader" style="display: none;">@include('PNPadmin.includes.loader')</div>
                                        </div>
                                        <div class="col-xl-8 border-right">
                                            <div id="reports-activity-station-display" style="display: none;">
                                                <ul id="reports-activity-station-incident-type" class="nav nav-tabs nav-style-border justify-content-between justify-content-xl-start" role="tablist"></ul>
                                                <div class="card-body">
                                                    <canvas id="reports-activity-station-chart" class="chartjs" style="min-height: 400px;"></canvas>
                                                </div>
                                                <div class="p-4">
                                                    <a id="reports-activity-station-print" target="_blank" class="btn btn-sm btn-secondary"><i class="mdi mdi-printer"></i> Print or Save</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-4">
                                            <div id="reports-activity-station-display-average" style="display: none;">
                                                <div data-scroll-height="642">
                                                    <div class="card-header row pt-4 mx-0 px-0">
                                                        <div class="row col-lg-12 d-flex justify-content-center mb-3">
                                                            <p class="my-2">Average Incident Reports Per</p>
                                                        ...
                                                        <div class="row col-lg-12">
                                                            <span class="col-lg-3 text-center">Day <h4 id="reports-activity-station-ave-per-day"></h4></span>
                                                            <span class="col-lg-3 text-center">Week <h4 id="reports-activity-station-ave-per-week"></h4></span>
                                                            <span class="col-lg-3 text-center">Month <h4 id="reports-activity-station-ave-per-month"></h4></span>
                                                            <span class="col-lg-3 text-center">Year <h4 id="reports-activity-station-ave-per-year"></h4></span>
                                                        </div>
                                                    </div>
                                                    <div class="border-bottom"></div>
                                                    <div class="card-body">
                                                        <canvas id="reports-activity-station-barchart" class="chartjs" style="min-height: 500px;"></canvas>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="reports-activity-station-search" style="display: none;">
                                            <ul id="reports-activity-station-incident-type-search" class="nav nav-tabs nav-style-border justify-content-between justify-content-xl-start border-bottom" role="tablist">
                                            </ul>
                                            <div class="card-body">
                                                <canvas id="reports-activity-station-chart-search" class="chartjs" style="min-height: 400px;"></canvas>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card card-default" id="stations-activity">
                            <div class="card-header justify-content-between">
                                <h2>Stations Activity</h2>
                                <form id="stations-activity-search-form">
                                @csrf
                                    <div class="row">
                                        <input id="stations-activity-from" name="from" type="date" style="display: none;" required>
                                        <input id="stations-activity-to" name="to" class="form-control" type="date" style="display: none;" required>
                                        <div id="stations-activity-date-range" class="date-range-report mr-2"><span>Select Date</span></div>
                                        <div class="btn-group d-flex justify-content-end">
                                            <button type="submit" class="btn btn-outline-primary btn-sm"><i class="mdi mdi-magnify"></i> Search Date</button>
                                            <a id="stations-activity-view-all" href="javascript:void(0);" class="btn btn-primary btn-sm"><i class="mdi mdi-format-columns"></i> View All</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            @if($stationcount != 0)
                            <div id="stations-activity-loader">@include('PNPadmin.includes.loader')</div>
                            <div id="stations-activity-display" style="display: none;">
                                <div class="card-body" style="height: 300px;">
                                    <canvas id="stations-activity-chart"></canvas>
                                    <div id='customLegend' class='customLegend'></div>
                                </div>
                                <div class="d-flex justify-content-end p-4">
                                    <a href="{{url('admin/print/stations-activity')}}" target="_blank" class="btn btn-sm btn-secondary"><i class="mdi mdi-printer"></i> Print or Save</a>
                                </div>
                            </div>
                            <div id="stations-activity-search" class="pb-6" style="display: none;">
                                <div class="card-body" style="height: 300px;">
                                    <canvas id="stations-activity-chart-search"></canvas>
                                    <div id='customLegend-search' class='customLegend'></div>
                                </div>
                                <!-- <div class="d-flex justify-content-end p-4">
                                    <a href="javascript:void(0);" target="_blank" class="btn btn-sm btn-secondary"><i class="mdi mdi-printer"></i> Print or Save</a>
                                </div> -->
                            </div>
                            @else 
                            <div class="col-lg-12 text-center py-6">
                                <span>No Registered Stations Yet</span>
                            </div>
                            @endif
                        </div>

                        <div class="card card-default" id="users-activity">
                            <div id="users-activity-loader">@include('PNPadmin.includes.loader')</div>
                            <div id="users-activity-display" class="row no-gutters" style="display: none;">
                                <div class="col-lg-7 border-right">
                                    <div class="card-header justify-content-between pb-4">
                                        <h2 class=" text-dark">Users Activity</h2>
                                    </div>
                                    @if($users != 0)
                                    <div class="card-body pt-0 mb-5" style="position: relative; height:45vh">
                                        <ul class="nav nav-tabs nav-style-border pl-0 mb-4 justify-content-between justify-content-xl-start" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="javascript:void(0);" role="tab" aria-controls="home2" aria-selected="true">Registrations</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="javascript:void(0);" role="tab" aria-controls="profile2" aria-selected="false">Reported an Incident</a>
                                            </li>
                                        </ul>
                                        <canvas id="users-activity-chart" class="chartjs"></canvas>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    @if($users != 0)
                                    <div class="card-body">
                                        <canvas id="users-activity-barChart" class="chartjs" style="min-height: 280px"></canvas>
                                    </div>
                                    @else 
                                    <div class="col-lg-12 text-center py-6">
                                        <span>No Registered Users Yet</span>
                            ...
                            <div class="card-body">
                                ...
                                @csrf
                                    <div class="row mt-4 d-flex justify-content-end">
                                        ...
                                        @else
                                        <button class="btn btn-outline-primary" disabled>No Reports Yet</button>
                                        @endif
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="card card-default" id="report-logs" data-scroll-height="500">
                            ...
                            @else
                                <span class="text-center py-6">No Reports Yet</span>
                            @endif
                        </div>	
                        ...
                        <div class="card card-default" id="reports-list">
                            ...
                            <div class="card-body">
                                <div id="reports-list-loader" style="display: none;">@include('PNPadmin.includes.loader')</div>
                        ...
                        <div class="card card-default" id="officers-list">
                            ...
                            <div class="card-body">
                                <div id="officers-list-loader" style="display: none;">@include('PNPadmin.includes.loader')</div>
                        ...
                        <div class="card card-default" id="users-list">
                            <div class="card-header card-header-border-bottom justify-content-between">
                                <h2>Users List</h2>
                                <form id="users-list-datepicker-search-form">
                                @csrf
                                    <div class="row">
                                        <input id="users-list-search-from" name="from" type="date" style="display: none;" required>
                                        <input id="users-list-search-to" name="to" class="form-control" type="date" style="display: none;" required>
                                        <div id="users-list-search-date-range" class="date-range-report mr-2"><span>Select Date</span></div>
                                        <div class="btn-group d-flex justify-content-end">
                                            <button type="submit" class="btn btn-outline-primary btn-sm"><i class="mdi mdi-magnify"></i> Search Date</button>
                                            <a id="users-list-display" href="javascript:void(0);" class="btn btn-primary btn-sm"><i class="mdi mdi-format-columns"></i> View All</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="card-body">
                                <div id="users-list-loader" style="display: none;">@include('PNPadmin.includes.loader')</div>
                                <div id="users-list-table" class="basic-data-table" style="overflow: hidden;">
                                    <table id="users-list-data-table" class="table table-hover dt-responsive" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Contact #</th>
                                ...
                                <div id="users-list-search-table" class="basic-data-table" style="overflow: hidden; display: none;">
                                    <h4>Results: <span class="text-primary" id="users-list-search-table-count">0</span> report/s</h4>
                                    <table id="users-list-data-table-search" class="table table-hover dt-responsive" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Contact #</th>
...
<script>
    $(document).ready(function() {
        ...
        /* $('#users-list-data-search').DataTable({
            "dom": '<"row justify-content-between top-information"lf>rt<"row justify-content-between bottom-information"ip><"clear">',
            ordering: false,
            searching: false,
            paging: false,
        ...
        $('#reports-list-data-table').DataTable({
            ...
            ajax: {
                url: "{{url('admin/statistical-reports/reports-list')}}",
            },
            columns: [
        ...
        $('#officers-list-data-table').DataTable({
            ...
            serverSide: true,
            language: {
                emptyTable: 'No Police Officers.',
                zeroRecords: 'No Officer Found. Try Searching another keyword.',
            },
            ajax: {
                url: "{{url('admin/statistical-reports/officers-list')}}",
            },
            columns: [
                ...
                { render: function(data, type, row) {
                    if(row["station_id"] == null) {
                        ...
                        return row.get_station["station_name"];
                    }
                } },
            ...
            /* createdRow: function(data, type, row) {
                $(this).attr('data-id', row.id).attr('data-toggle', 'modal').attr('data-target', '#view-officer');
            }, */
        });
        $('#users-list-data-table').DataTable({
            "dom": '<"row justify-content-between top-information"lf>rt<"row justify-content-between bottom-information"ip><"clear">',
            ordering: true,
            processing: true,
            serverSide: true,
            ...
            ajax: {
                url: "{{url('admin/statistical-reports/users-list')}}",
            },
            columns: [
                ...
                { data: 'status', render: function(data) {
                    if(data == "verified") {
                        ...
                        return '<span class="text-danger"><i class="mdi mdi-close"></i> Blocked </span>';
                    }
                } },
            ]
        });
...
<script>
$(document).ready(function() {
    $('#reports-activity-print').on('click',function(){
        var divToPrint = document.getElementById("reports-list-data-table");
        newWin= window.open("");
...
$(document).ready(function() {
    ...
    $('#scroll-to-stations-activity').click(function() {
        $('html,body').animate({
            scrollTop: $("#stations-activity").offset().top - 100},
        'slow');
    });
    $('#scroll-to-users-activity').click(function() {
        $('html,body').animate({
            scrollTop: $("#users-activity").offset().top - 100},
        'slow');
    });
    ...
    $('#scroll-to-users-list').click(function() {
        $('html,body').animate({
            scrollTop: $("#users-list").offset().top - 100},
        'slow');
    });
...
$(document).ready(function() {
    ...
    $('#reports-activity-search').on('submit', function(event) {
        ...
        $.ajax({
            ...
            url: "{{ url('admin/statistical-reports/report-activity/search-by-date') }}",
    ...
    /* ================ STATION REPORT ACTIVITY ==================== */
    $('#reports-activity-station-form').on('submit', function(event) {
        event.preventDefault();
        
        $('#reports-activity-station-display').hide();
        $('#reports-activity-station-display-average').hide();
        $('#reports-activity-station-loader').show();

        $.ajax({
            type: "POST",
            url: "{{url('admin/statistical-reports/report-activity-station')}}",
            data: new FormData(this),
            dataType: "JSON",
            contentType: false,
            cache: false,
            processData: false,
            success: function(result) {
                $('#reports-activity-station-print').attr('href', '/admin/print/report/asdsfd462sdaf4134234hgh'+result.station_id+'dfsfddsfasdg23572412f');
                $('#reports-activity-station-incident-type').html(result.view);
                $('#reports-activity-station-ave-per-day').html(Math.round(result.reports_ave_day));
                $('#reports-activity-station-ave-per-week').html(Math.round(result.reports_ave_week));
                $('#reports-activity-station-ave-per-month').html(Math.round(result.reports_ave_month));
                $('#reports-activity-station-ave-per-year').html(Math.round(result.reports_ave_year));

                /* INCIDENT REPORTS ACTIVIY */
                var activity = document.getElementById("reports-activity-station-chart");
                if (activity !== null) {
                    var activityData = [
                    {
                        /* reports: result.all, */
                    ...
                    var ctx = document.getElementById("reports-activity-station-chart").getContext("2d");
                    var myLine = new Chart(ctx, config);
                }
                /* INCIDENT REPORTS ACTIVIY */

                /* AVE INCIDENT REPORTS */
                var cUser = document.getElementById("reports-activity-station-barchart");
                if (cUser !== null) {
                    var myUChart = new Chart(cUser, {
                        type: "bar",
                        data: {
            ...
            complete: function() {
                $('#reports-activity-station-loader').hide();
                $('#reports-activity-station-display').show();
                $('#reports-activity-station-display-average').show();
            },
            error: function(error) {
                console.log(error);
            }
    ...
    $('#reports-list-datepicker-search-form').on('submit', function(event) {
        ...
        $.ajax({
            type: "POST",
            enctype: "multipart/form-data",
            url: "{{ url('admin/statistical-reports/reports-list/search-by-date') }}",
            data: new FormData(this),
            dataType: "JSON",
            contentType: false,
            cache: false,
    ...
    $.ajax({
        ...
        success: function(result) {
            /* USER ACTIVITY CHART */
            var ctx = document.getElementById("users-activity-chart");
            if (ctx !== null) {
                var activityData = [ 
                    { ave: [ Math.round(result.ave_day * 100) / 100, 
                            Math.round(result.ave_week * 100) / 100, 
                            Math.round(result.ave_month * 100) / 100, 
                            Math.round(result.ave_year * 100) / 100 ]
                    },
                    { ave: [ Math.round(result.ave_day_report * 100) / 100, 
                        ...
                        tooltips: {
                            callbacks: {
                                ...
                                label: function (tooltipItem, data) {
                                    return data["datasets"][0]["data"][tooltipItem["index"]] + " Average";
                                }
                            },
                            responsive: true,
                            intersect: false,
                ...
                var items = document.querySelectorAll("#users-activity .nav-tabs .nav-item");
                items.forEach(function (item, index) {
                    item.addEventListener("click", function () {
                        config.data.datasets[0].data = activityData[index].ave;
                        myLine.update();
                    });
                });
            }
            ...
            var cUser = document.getElementById("users-activity-barChart");
            if (cUser !== null) {
                var myUChart = new Chart(cUser, {
                type: "bar",
                data: {
                    ...
                    datasets: [
                    {
                        ...
                        data: [result.today, result.yesterday, result.week, result.month, result.year, result.count],
    ...
    /* =============== STATION ACTIVITY ============== */
    $('#stations-activity-view-all').click(function() {
        $('#stations-activity-search').hide();
        $('#stations-activity-display').show();
    })
    $.ajax({
        type: "GET",
    ...
    /* ================== STATION ACTIVITY SEARCH ================== */
    $('#stations-activity-search-form').on('submit', function(event) {
        event.preventDefault();

        $('#stations-activity-display').hide();
        $('#stations-activity-search').hide();
        $('#stations-activity-loader').show();

        $.ajax({
            type: "POST",
            enctype: "multipart/form-data",
            url: "{{ url('admin/statistical-reports/stations-activity/search') }}",
            data: new FormData(this),
            dataType: "JSON",
            contentType: false,
            cache: false,
            processData: false,
            success: function(result) {
                var sachart = document.getElementById("stations-activity-chart-search");
                if (sachart !== null) {
                var acChart3 = new Chart(sachart, {
                    // The type of chart we want to create
                    type: "bar",
                    ...
                    datasets: [
                        {
                            ...
                            backgroundColor: "rgb(255, 76, 66)",
                            borderColor: "rgba(255, 76, 66,0)",
                            data: result.station_report_count_bogus,
                            pointBackgroundColor: "rgba(255, 76, 66,0)",
                            pointHoverBackgroundColor: "rgba(255, 76, 66,1)",
                            pointHoverRadius: 3,
                            pointHitRadius: 30
                        },
                        {
                            ...
                            backgroundColor: "rgb(41, 204, 151)",
                            borderColor: "rgba(41, 204, 151,0)",
                            data: result.station_report_count_verified,
                            pointBackgroundColor: "rgba(41, 204, 151,0)",
                            pointHoverBackgroundColor: "rgba(41, 204, 151,1)",
                            pointHoverRadius: 3,
                            pointHitRadius: 30
                    ...
                    document.getElementById("customLegend-search").innerHTML = acChart3.generateLegend();
                }
            },
            complete: function() {
                $('#stations-activity-loader').hide();
                $('#stations-activity-search').show();
            },
            error: function(error) {
                console.log(error);
            }
    ...
    /* ================ END STATION ACTIVITY SEARCH ================== */

    /* =========== USERS LIST ================= */
    $('#users-list-display').click(function() {
        $('#users-list-table').show();
        $('#users-list-search-table').hide();
    })
    $('#users-list-datepicker-search-form').on('submit', function(event) {
        event.preventDefault();

        $('#users-list-table').hide();
        $('#users-list-search-table').hide();
        $('#users-list-loader').show();

        $.ajax({
            type: "POST",
            enctype: "multipart/form-data",
            url: "{{ url('admin/statistical-reports/users-list/search-by-date') }}",
            data: new FormData(this),
            dataType: "JSON",
            contentType: false,
            cache: false,
            ...
            success: function(result) {
                if(result.view2) {
                    $('#users-list-search-table-count').html(result.count2);
                    $('#users-list-tbody').html(result.view2);
                } else {
                    $('#users-list-search-table-count').html(result.count);
                    $('#users-list-tbody').html(result.view);
                }
            },
            complete: function() {
                $('#users-list-loader').hide();
                $('#users-list-search-table').show();
            },
            error: function(error) {
                console.log(error);
            }
    ...
    $('#view-dispatch').on('show.bs.modal', function(event) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $('#view-dispatch-print').attr('href', '/admin/print/report/dg1234d2sadfg214'+id+'sdfgsdfdf22g3214sdaf');
    ...
    function incidentReports() {
        $.ajax({
            type: "GET",
            url: "{{ url('admin/statistical-reports/report-logs') }}",
            dataType: "JSON",
            success: function(result) {
    ...
    $('#map-search-form').on('submit', function(event) {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('admin/statistical-reports/map-search')}}",
...
<script>
    $(document).ready(function() {
        ...
        $('#reports-activity-print-from').val(moment().format('YYYY-MM-DD'));
        $('#reports-activity-print-to').val(moment().format('YYYY-MM-DD'));
        ...
        $("#reports-activity-date-range").daterangepicker({
            ...
            $('#reports-activity-print-from').val(start.format('YYYY-MM-DD'));
            $('#reports-activity-print-to').val(end.format('YYYY-MM-DD'));
        ...
        /* DATE RANGE OF USERS LIST */
        $("#users-list-search-date-range span").html(moment().format("ll") + " - " + moment().format("ll"));
        $('#users-list-search-from').val(moment().format('YYYY-MM-DD'));
        $('#users-list-search-to').val(moment().format('YYYY-MM-DD'));

        $("#users-list-search-date-range").daterangepicker({
            maxDate: moment(),
            startDate: moment(),
            endDate: moment(),
            format: 'YYYY-MM-DD',
            ...
            $('#users-list-search-from').val(start.format('YYYY-MM-DD'));
            $('#users-list-search-to').val(end.format('YYYY-MM-DD'));
            $("#users-list-search-date-range span").html(start.format("ll") + " - " + end.format("ll"));
            console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
        });
        /* END DATE RANGE OF USERS LIST */

        /* DATE RANGE OF STATIONS ACTIVITY */
        $("#stations-activity-date-range span").html(moment().format("ll") + " - " + moment().format("ll"));
        $('#stations-activity-from').val(moment().format('YYYY-MM-DD'));
        $('#stations-activity-to').val(moment().format('YYYY-MM-DD'));

        $("#stations-activity-date-range").daterangepicker({
            maxDate: moment(),
            startDate: moment(),
            endDate: moment(),
            format: 'YYYY-MM-DD',
            ...
            $('#stations-activity-from').val(start.format('YYYY-MM-DD'));
            $('#stations-activity-to').val(end.format('YYYY-MM-DD'));
            $("#stations-activity-date-range span").html(start.format("ll") + " - " + end.format("ll"));
            console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
        });
        /* END DATE RANGE OF STATIONS ACTIVITY */
    })
</script>
<!-- ============================================ END DATE PICKER ================================================= -->
