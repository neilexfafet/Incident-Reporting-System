            ...
            <div class="navbar-right">
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <li class="dropdown-header">Notification(s)</li>
                        ...
                        <!-- <li class="text-center" id="notifications-view-none" style="display:none;">
                            No Notifications Yet...
                        </li> -->

                    <li class="dropdown-footer">
                            <a class="right-sidebar-in right-sidebar-2-menu" href="javascript:void(0);"> View All </a>
                        <!-- <a class="text-center" href="{{ url('admin/notifications') }}"> View All </a> -->
                    </li>
                    </ul>
                </li>
                <!-- <li class="right-sidebar-in right-sidebar-2-menu">
                    <i class="mdi mdi-settings mdi-spin"></i>asdasd
                </li> -->
                <!-- User Account -->
                <li class="dropdown user-menu">
                    ...
                    @else
                        <img src="{{ asset(Auth::guard('admin')->user()->image) }}" class="user-image" alt="User Image" />
                    @endif 
                    <span class="d-none d-lg-inline-block">{{ Auth::guard('admin')->user()->admin_name }}</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                    <!-- User image -->
                    <li class="dropdown-header">
                        ...
                        {{ Auth::guard('admin')->user()->admin_name }} <small class="pt-1">{{ Auth::guard('admin')->user()->username }}</small>
                        </div>
                    </li>

                    <li>
                        <a href="{{ url('admin/users') }}">
                        <i class="mdi mdi-account-details text-dark"></i> Admin Users
                        </a>
                    </li>
                    <li>
